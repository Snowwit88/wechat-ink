...
shell='''<!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>微墨 v2 · 先看一篇成品</title><style>
...
</style></head><body><main><section><div class="badge">微墨 / V2 PREVIEW</div><h1>先看成品。<br>再开始创作。</h1><p>把文稿、图片和资料，整理成一篇清晰的公众号文章。这里是新版排版器实际生成的完整样稿。</p><div class="steps"><div><b>01</b>你的主题与资料 → 已有 AI 助手创作</div><div><b>02</b>文稿与图片 → 微墨排版与预览</div><div><b>03</b>确认成品 → 可选发送到微信草稿箱</div></div><div class="note">当前展示预置文章和程序绘制的测试图。此页不联网、不读取密钥、不生成新文章、不发送草稿。右侧文稿可滚动查看。</div><footer>想试自己的文章？查看项目内 README.md 的“开始创作”。<br>生图和草稿发布需另行配置，尚待真实服务验收。<br><a href="https://github.com/Snowwit88/wechat-ink">微墨 GitHub 项目</a> · <a href="https://github.com/Snowwit88/wechat-ink/tree/legacy-v1">第一版入口</a></footer></section><section class="phone"><iframe title="微墨完整样稿" srcdoc="__ARTICLE__"></iframe><div class="caption">真实排版输出 · 七张测试图 · 完整参考资料</div></section></main></body></html>'''
(root/'demo.html').write_text(shell.replace('__ARTICLE__',html.escape(preview,quote=True)),encoding='utf-8')
