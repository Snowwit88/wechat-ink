...
import {
  ...
  type CliArgs,
  type Provider,
} from "./ink_image_gen_core";

function printUsage(): void {
  console.log(`Usage:
  bun scripts/ink_image_gen.ts --prompt "A cat" --image cat.png
  bun scripts/ink_image_gen.ts --promptfiles style.md subject.md --image out.png
