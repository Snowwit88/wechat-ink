...
账号可以在 `wechat-ink.yaml` 分别配 `image_style` 和 `newspic_image_style`:
...
3. 在 `wechat-ink.yaml` 的账号下配 `image_style: <name>` 和 `newspic_image_style: <name>`
