"""
pytest fixtures for wechat-ink.
...
# ---------------------------------------------------------------------------
# wechat-ink.yaml fixture
# ---------------------------------------------------------------------------

# Minimal but realistic wechat-ink.yaml content.
...
def tmp_config_yaml(tmp_path, monkeypatch):
    """
    Drop a minimal `wechat-ink.yaml` into a temp directory.
